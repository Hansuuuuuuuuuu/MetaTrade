...
class UserListingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_listing" do
    assert_difference('UserListing.count') do
      post user_listings_url, params: { user_listing: { card_name: @user_listing.card_name, condition: @user_listing.condition, price: @user_listing.price, quantity: @user_listing.quantity } }
    end
  ...
  test "should update user_listing" do
    patch user_listing_url(@user_listing), params: { user_listing: { card_name: @user_listing.card_name, condition: @user_listing.condition, price: @user_listing.price, quantity: @user_listing.quantity } }
