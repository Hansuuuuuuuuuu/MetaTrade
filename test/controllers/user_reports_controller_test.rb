...
class UserReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_report" do
    assert_difference('UserReport.count') do
      post user_reports_url, params: { user_report: { reason: @user_report.reason, reporter: @user_report.reporter, user_id: @user_report.user_id } }
    end
  ...
  test "should update user_report" do
    patch user_report_url(@user_report), params: { user_report: { reason: @user_report.reason, reporter: @user_report.reporter, user_id: @user_report.user_id } }
